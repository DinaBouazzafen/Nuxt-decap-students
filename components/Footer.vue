                ...
                <div class="flex basis-1/12">
                    <div class="flex-1 basis-4/12 ">
                        <NuxtLink to="/">
                            ...
                            <span class="hidden-on-hover">Buckhain</span>
                        </NuxtLink> 
                    </div>
                    ...
                    <!-- <div class="flex-1 basis-4/12 ">
                        <NuxtLink to="/search">
                            ...
                            <span class="hidden-on-hover">Huh?</span>
                        </NuxtLink> 
                    </div> -->
                    ...
                    <!-- <div class="flex-1 basis-4/12 text-right">
                        <NuxtLink to="https://github.com/bureaupixel/" target="_blank">
                            ...
                            <span class="hidden-on-hover">Ze code</span>
                        </NuxtLink>
                    </div>  -->
                    ...
                    <div class="flex-1 basis-4/12 text-right">
                        <NuxtLink to="/admin" target="_blank">
                            ...
                            <span class="hidden-on-hover">Mine</span>
                        </NuxtLink>
                    </div> 
                </div>
            </div>
